//! Communication with a Lumos node over RPC.
//!
//! Software that interacts with the Lumos blockchain, whether querying its
//! state or submitting transactions, communicates with a Lumos node over
...
#[allow(deprecated)]
use lumos_rpc_client_api::deprecated_config::{
...
/// A client of a remote Lumos node.
///
/// `RpcClient` communicates with a Lumos node over [JSON-RPC], with the
/// [Lumos JSON-RPC protocol][jsonprot]. It is the primary Rust interface for
...
/// documentation.
///
/// [`Finalized`]: lumos_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: lumos_sdk::commitment_config::CommitmentLevel::Processed
/// [jsonprot]: https://lumos.com/docs/rpc
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://lumos.com/docs/terminology#slot
/// [cl]: https://lumos.com/docs/rpc#configuring-state-commitment
///
/// # Errors
///
/// Methods on `RpcClient` return
/// [`client_error::Result`][lumos_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][lumos_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][lumos_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][lumos_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][lumos_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use lumos_sdk::system_transaction;
/// # use lumos_rpc_client_api::client_error::Error;
/// # use lumos_rpc_client::rpc_client::RpcClient;
/// # use lumos_sdk::signature::{Keypair, Signer};
...
/// [`reqwest::Error`](lumos_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](lumos_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
///
/// [`ClientError`]: lumos_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: lumos_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: lumos_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: lumos_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// behaviors determined by internal Lumos test cases. New users should
    ...
    ///
    /// [`RpcError`]: lumos_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: lumos_rpc_client_api::request::RpcError::RpcResponseError
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: lumos_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: lumos_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: lumos_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`sendTransaction`]: https://lumos.com/docs/rpc/http/sendtransaction
    /// [`getLatestBlockhash`]: https://lumos.com/docs/rpc/http/getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`skip_preflight`]: lumos_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: lumos_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`err`]: lumos_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: lumos_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    /// Simulating a transaction is similar to the ["preflight check"] that is
    /// run by default when sending a transaction.
    ///
    /// ["preflight check"]: https://lumos.com/docs/rpc/http/sendtransaction
    ///
    ...
    /// [`sig_verify`]: lumos_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ///
    /// [`simulateTransaction`]: https://lumos.com/docs/rpc/http/simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`accounts`]: lumos_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: lumos_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://lumos.com/docs/rpc/http/gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: lumos_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][lumos_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    ///
    /// [`getSlot`]: https://lumos.com/docs/rpc/http/getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://lumos.com/docs/rpc/http/getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://lumos.com/docs/rpc/http/getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    /// # use lumos_rpc_client_api::client_error::Error;
    /// # use lumos_rpc_client::rpc_client::RpcClient;
    /// # use lumos_sdk::slot_history::Slot;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    ///
    /// [`getBlockProduction`]: https://lumos.com/docs/rpc/http/getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://lumos.com/docs/rpc/http/getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://lumos.com/docs/rpc/http/getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://lumos.com/docs/rpc/http/getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://lumos.com/docs/rpc/http/getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://lumos.com/docs/rpc/http/getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://lumos.com/docs/rpc/http/getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # use lumos_rpc_client_api::client_error::Error;
    /// # use lumos_rpc_client::rpc_client::RpcClient;
    /// # use lumos_transaction_status::UiTransactionEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    ///
    /// [`getBlocks`]: https://lumos.com/docs/rpc/http/getblocks
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: lumos_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
    ...
    ///
    /// [`getBlocksWithLimit`]: https://lumos.com/docs/rpc/http/getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://lumos.com/docs/rpc/deprecated/getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getSignaturesForAddress`]: https://lumos.com/docs/rpc/http/getsignaturesforaddress
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    /// # use lumos_rpc_client_api::client_error::Error;
    /// # use lumos_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use lumos_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     system_transaction,
    ...
    ///
    /// [`getTransaction`]: https://lumos.com/docs/rpc/http/gettransaction
    ...
    ///
    /// [`getLeaderSchedule`]: https://lumos.com/docs/rpc/http/getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochSchedule`]: https://lumos.com/docs/rpc/http/getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://lumos.com/docs/rpc/http/getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPrioritizationFees`]: https://lumos.com/docs/rpc/http/getrecentprioritizationfees
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://lumos.com/docs/rpc/http/getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://lumos.com/docs/rpc/http/getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://lumos.com/docs/rpc/http/getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://lumos.com/docs/rpc/http/getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the current lumos version running on the node.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getVersion`] RPC method.
    ///
    /// [`getVersion`]: https://lumos.com/docs/rpc/http/getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.lumos_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://lumos.com/docs/rpc/http/minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`RpcError::ForUser`]: lumos_rpc_client_api::request::RpcError::ForUser
    ...
    ///
    /// [`getAccountInfo`]: https://lumos.com/docs/rpc/http/getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    /// # use lumos_rpc_client_api::client_error::Error;
    /// # use lumos_rpc_client::rpc_client::{self, RpcClient};
    /// # use lumos_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use lumos_account_decoder::UiAccountEncoding;
    /// # use std::str::FromStr;
    /// # let mocks = rpc_client::create_rpc_client_mocks();
    /// # let rpc_client = RpcClient::new_mock_with_mocks("succeeds".to_string(), mocks);
    /// let alice_pubkey = Pubkey::from_str("BgvYtJEfmZYdVKiptmMjxGzv8iQoo4MWjsP3QsTkhhxa").unwrap();
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://lumos.com/docs/rpc/http/getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://lumos.com/docs/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://lumos.com/docs/rpc/http/getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://lumos.com/docs/rpc/http/getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://lumos.com/docs/rpc/http/getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBalance`]: https://lumos.com/docs/rpc/http/getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://lumos.com/docs/rpc/http/getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use lumos_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
    ...
    ///
    /// [`getStakeMinimumDelegation`]: https://lumos.com/docs/rpc/http/getstakeminimumdelegation
    ///
    /// # Examples
    ///
    /// ```
...
mod tests {
    use {
        ...
        lumos_rpc_client_api::client_error::ErrorKind,
        lumos_sdk::{
