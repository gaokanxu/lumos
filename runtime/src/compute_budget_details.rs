use {
    lumos_program_runtime::compute_budget_processor::process_compute_budget_instructions,
    lumos_sdk::{
    ...
    fn test_get_compute_budget_details_with_valid_request_heap_frame_tx() {
        ...
        assert_eq!(
            ...
            Some(ComputeBudgetDetails {
                ...
                compute_unit_limit:
                    lumos_program_runtime::compute_budget_processor::DEFAULT_INSTRUCTION_COMPUTE_UNIT_LIMIT
                    as u64,
            })
        );
