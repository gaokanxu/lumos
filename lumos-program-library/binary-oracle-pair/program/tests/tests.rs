...
use {
    ...
    lumos_program::{hash::Hash, program_pack::Pack, pubkey::Pubkey, system_instruction},
    lumos_program_test::*,
    lumos_sdk::{
        account::Account,
...
pub async fn get_token_balance(banks_client: &mut BanksClient, token: &Pubkey) -> u64 {
    ...
    let account_info: lpl_token::state::Account =
        lpl_token::state::Account::unpack_from_slice(token_account.data.as_slice()).unwrap();
    account_info.amount
}
