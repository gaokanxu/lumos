...
use {
    lumos_program::system_instruction,
    lumos_program_test::{processor, tokio::sync::Mutex, ProgramTest, ProgramTestContext},
    lumos_sdk::{pubkey::Pubkey, signature::Keypair, signer::Signer, transaction::Transaction},
    lpl_token_client::{
        client::{
...
pub async fn setup_program_test(
    ...
    let mut program_test = ProgramTest::new(
        "lpl_token_collection",
        *program_id,
        processor!(lpl_token_collection::processor::process),
    );
