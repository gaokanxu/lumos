...
use {
    ...
    lpl_type_length_value::state::TlvStateMut,
};
...
pub fn process(program_id: &Pubkey, accounts: &[AccountInfo], input: &[u8]) -> ProgramResult {
    ...
    match instruction {
        ...
        TokenGroupInstruction::UpdateGroupMaxSize(data) => {
            ...
            lpl_token_group_example::processor::process_update_group_max_size(
        ...
        TokenGroupInstruction::UpdateGroupAuthority(data) => {
            ...
            // Same functionality as the example program
            lpl_token_group_example::processor::process_update_group_authority(
                program_id, accounts, data,
            )
        }
