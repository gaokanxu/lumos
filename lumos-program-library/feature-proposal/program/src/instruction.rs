...
pub enum FeatureProposalInstruction {
    ...
    ///   described in `lumos_program::feature`)
    ///
...
pub fn propose(
    ...
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(lumos_program::system_program::id(), false),
...
mod tests {
    ...
    fn test_get_packed_len() {
        assert_eq!(
            ...
            lumos_program::borsh1::get_packed_len::<FeatureProposalInstruction>()
        )
    }
