use anchor_lang::{
    prelude::*,
    lumos_program::{msg, program_error::ProgramError},
};
use bytemuck::PodCastError;
use lpl_concurrent_merkle_tree::error::ConcurrentMerkleTreeError;
...
pub enum AccountCompressionError {
    ...
    /// See [ConcurrentMerkleTreeHeader](/lpl_account_compression/state/struct.ConcurrentMerkleTreeHeader.html) for valid configuration options.
