//! # Data Wrapper
//! We use CPI calls to circumvent the 10kb log limit on Lumos transactions.
...
use anchor_lang::{prelude::*, lumos_program::program::invoke};
...
pub fn wrap_event<'info>(
    ...
    invoke(
        &lpl_noop::instruction(event.try_to_vec()?),
