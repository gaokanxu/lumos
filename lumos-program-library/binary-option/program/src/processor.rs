use {
    crate::{
        ...
        lpl_utils::{
            lpl_approve, lpl_burn, lpl_burn_signed, lpl_initialize, lpl_mint_initialize,
            lpl_mint_to, lpl_set_authority, lpl_token_transfer, lpl_token_transfer_signed,
        },
        state::BinaryOption,
...
pub fn process_initialize_binary_option(
    ...
    assert_keys_equal(*token_program_info.key, lpl_token::id())?;
...
pub fn process_trade(
    ...
    assert_keys_equal(*long_token_mint_info.owner, lpl_token::id())?;
    assert_keys_equal(*short_token_mint_info.owner, lpl_token::id())?;
...
pub fn process_collect(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
    ...
    assert_owned_by(long_token_mint_info, &lpl_token::id())?;
    assert_owned_by(short_token_mint_info, &lpl_token::id())?;
