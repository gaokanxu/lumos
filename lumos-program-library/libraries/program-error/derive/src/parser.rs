...
/// Possible arguments to the `#[lpl_program_error]` attribute
pub struct SplProgramErrorArgs {
    /// Whether to hash the error codes using `lumos_program::hash`
...
/// Parser for args to the `#[lpl_program_error]` attribute
/// ie. `#[lpl_program_error(hash_error_code_start = 1275525928)]`
