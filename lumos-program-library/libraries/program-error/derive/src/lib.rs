//! Crate defining a procedural macro for building Lumos program errors
...
/// Derive macro to add `Into<lumos_program::program_error::ProgramError>`
/// trait
...
/// Derive macro to add `lumos_program::decode_error::DecodeError` trait
...
/// Derive macro to add `lumos_program::program_error::PrintProgramError` trait
...
/// Proc macro attribute to turn your enum into a Lumos Program Error
///
/// Adds:
/// - `Clone`
/// - `Debug`
...
/// - `Into<lumos_program::program_error::ProgramError>`
/// - `lumos_program::decode_error::DecodeError`
...
///
/// Syntax: `#[lpl_program_error(hash_error_code_start = 1275525928)]`
/// Hash Input: `lpl_program_error:<enum name>:<variant name>`
/// Value: `u32::from_le_bytes(<hash of input>[13..17])`
#[proc_macro_attribute]
pub fn lpl_program_error(attr: TokenStream, input: TokenStream) -> TokenStream {
