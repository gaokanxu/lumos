...
pub(crate) fn initialize_mint<'a, 'b>(
    ...
    invoke(
        &lpl_token::instruction::initialize_mint2(
            token_program.key,
            mint.key,
            mint_authority,
...
pub(crate) fn thaw<'a, 'b>(
    ...
    invoke_signed(
        &lpl_token::instruction::thaw_account(
            token_program.key,
            target.key,
            mint.key,
...
pub(crate) fn freeze<'a, 'b>(
    ...
    invoke_signed(
        &lpl_token::instruction::freeze_account(
            token_program.key,
            target.key,
            mint.key,
            freeze_authority.key,
...
pub(crate) fn revoke<'a, 'b>(
    ...
    invoke(
        &lpl_token::instruction::revoke(token_program.key, account.key, owner.key, &[])?,
