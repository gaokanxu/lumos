...
use {
    ...
    lpl_pod::optional_keys::{OptionalNonZeroElGamalPubkey, OptionalNonZeroPubkey},
    lpl_token_2022::{
...
fn serde_instruction_elgamal_pubkey() {
    use lpl_token_2022::extension::confidential_transfer_fee::instruction::InitializeConfidentialTransferFeeConfigData;
...
fn serde_instruction_basis_points() {
    use lpl_token_2022::extension::interest_bearing_mint::instruction::InitializeInstructionData;
