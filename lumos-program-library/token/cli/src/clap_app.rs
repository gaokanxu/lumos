use {
    ...
    lumos_sdk::{instruction::AccountMeta, pubkey::Pubkey},
    lpl_token_2022::instruction::{AuthorityType, MAX_SIGNERS, MIN_SIGNERS},
    std::{fmt, str::FromStr},
...
pub static VALID_TOKEN_PROGRAM_IDS: [Pubkey; 2] = [lpl_token_2022::ID, lpl_token::ID];
