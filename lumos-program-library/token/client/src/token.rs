use {
    ...
    lpl_token_metadata_interface::state::{Field, TokenMetadata},
    std::{
        fmt, io,
        mem::size_of,
        sync::{Arc, RwLock},
...
fn native_mint(program_id: &Pubkey) -> Pubkey {
    if program_id == &lpl_token_2022::id() {
        lpl_token_2022::native_mint::id()
    } else if program_id == &lpl_token::id() {
...
fn native_mint_decimals(program_id: &Pubkey) -> u8 {
    if program_id == &lpl_token_2022::id() {
        lpl_token_2022::native_mint::DECIMALS
    } else if program_id == &lpl_token::id() {
        lpl_token::native_mint::DECIMALS
    } else {
        panic!("Unrecognized token program id: {}", program_id);
    }
}
    ...
    T: SendTransaction + SimulateTransaction,
{
    ...
    pub async fn wrap<S: Signers>(
        ...
        let immutable_owner = self.program_id != lpl_token::id();
    ...
    pub async fn withdraw_excess_lamports<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_2022::instruction::withdraw_excess_lamports(
                &self.program_id,
                source,
                destination,
                authority,
    ...
    pub async fn token_metadata_initialize<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_metadata_interface::instruction::initialize(
                &self.program_id,
                &self.pubkey,
                update_authority,
                &self.pubkey,
    ...
    pub async fn token_metadata_initialize_with_rent_transfer<S: Signers>(
        ...
        instructions.push(lpl_token_metadata_interface::instruction::initialize(
            &self.program_id,
            &self.pubkey,
            update_authority,
            &self.pubkey,
    ...
    pub async fn token_metadata_update_field<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_metadata_interface::instruction::update_field(
                &self.program_id,
                &self.pubkey,
                update_authority,
                field,
    ...
    pub async fn token_metadata_update_field_with_rent_transfer<S: Signers>(
        ...
        instructions.push(lpl_token_metadata_interface::instruction::update_field(
            &self.program_id,
            &self.pubkey,
            update_authority,
            field,
    ...
    pub async fn token_metadata_update_authority<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_metadata_interface::instruction::update_authority(
                &self.program_id,
                &self.pubkey,
                current_authority,
    ...
    pub async fn token_metadata_remove_key<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_metadata_interface::instruction::remove_key(
                &self.program_id,
                &self.pubkey,
                update_authority,
                key,
    ...
    pub async fn token_group_initialize<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_group_interface::instruction::initialize_group(
                &self.program_id,
                &self.pubkey,
                &self.pubkey,
                mint_authority,
    ...
    pub async fn token_group_initialize_with_rent_transfer<S: Signers>(
        ...
        instructions.push(lpl_token_group_interface::instruction::initialize_group(
            &self.program_id,
            &self.pubkey,
            &self.pubkey,
            mint_authority,
    ...
    pub async fn token_group_update_max_size<S: Signers>(
        ...
        self.process_ixs(
            &[
                lpl_token_group_interface::instruction::update_group_max_size(
                    &self.program_id,
                    &self.pubkey,
                    update_authority,
                    new_max_size,
    ...
    pub async fn token_group_update_authority<S: Signers>(
        ...
        self.process_ixs(
            &[
                lpl_token_group_interface::instruction::update_group_authority(
                    &self.program_id,
                    &self.pubkey,
                    current_authority,
                    new_authority,
    ...
    pub async fn token_group_initialize_member<S: Signers>(
        ...
        self.process_ixs(
            &[lpl_token_group_interface::instruction::initialize_member(
                &self.program_id,
                &self.pubkey,
                &self.pubkey,
                mint_authority,
    ...
    pub async fn token_group_initialize_member_with_rent_transfer<S: Signers>(
        ...
        instructions.push(lpl_token_group_interface::instruction::initialize_member(
            &self.program_id,
            &self.pubkey,
            &self.pubkey,
            mint_authority,
