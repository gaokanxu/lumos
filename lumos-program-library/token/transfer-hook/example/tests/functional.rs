...
async fn success_execute() {
    ...
    let token_program_id = lpl_token_2022::id();
    let wallet = Keypair::new();
    let mint_address = lpl_transfer_hook_example::mint::id();
...
async fn fail_incorrect_mint() {
    ...
    let token_program_id = lpl_token_2022::id();
    let wallet = Keypair::new();
    // wrong mint, only `lpl_transfer_hook_example::mint::id()` allowed
