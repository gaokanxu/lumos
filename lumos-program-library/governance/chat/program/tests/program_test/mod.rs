use {
    ...
    lumos_program::{program_error::ProgramError, pubkey::Pubkey},
    lumos_program_test::{processor, ProgramTest},
    lumos_sdk::{signature::Keypair, signer::Signer},
    lpl_governance::{
        instruction::{
    ...
    lpl_governance_addin_mock::instruction::setup_voter_weight_record,
    lpl_governance_chat::{
        instruction::post_message,
        processor::process_instruction,
        state::{ChatMessage, GovernanceChatAccountType, MessageBody},
    },
    lpl_governance_test_sdk::{addins::ensure_addin_mock_is_built, ProgramTestBench},
    std::str::FromStr,
};
...
impl GovernanceChatProgramTest {
    ...
    async fn start_impl(use_voter_weight_addin: bool) -> Self {
        ...
        program_test.add_program(
            ...
            processor!(lpl_governance::processor::process_instruction),
        );
        ...
        let voter_weight_addin_id = if use_voter_weight_addin {
            ...
            program_test.add_program("lpl_governance_addin_mock", voter_weight_addin_id, None);
