...
use {
    ...
    lumos_program_test::{ProgramTest, ProgramTestContext},
    lumos_sdk::{
    ...
    lpl_token::instruction::{set_authority, AuthorityType},
    std::borrow::Borrow,
    tools::clone_keypair,
};
...
impl ProgramTestBench {
    ...
    pub async fn create_mint(
        ...
        let mint_rent = self.rent.minimum_balance(lpl_token::state::Mint::LEN);
    ...
    pub async fn create_empty_token_account(
        ...
        let create_account_instruction = system_instruction::create_account(
            ...
            self.rent
                .minimum_balance(lpl_token::state::Account::get_packed_len()),
    ...
    pub async fn mint_tokens(
        ...
        let mint_instruction = lpl_token::instruction::mint_to(
            &lpl_token::id(),
            token_mint,
            token_account,
    ...
    pub async fn create_token_account_with_transfer_authority(
        ...
        let approve_instruction = lpl_token::instruction::approve(
            &lpl_token::id(),
            &token_account_keypair.pubkey(),
            transfer_authority,
            &owner.pubkey(),
