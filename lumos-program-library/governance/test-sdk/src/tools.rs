use {
    lumos_program::{instruction::InstructionError, program_error::ProgramError},
    lumos_sdk::{signature::Keypair, transaction::TransactionError, transport::TransportError},
    std::convert::TryFrom,
};

/// TODO: Add to Lumos SDK
...
pub fn map_transaction_error(transport_error: TransportError) -> ProgramError {
    match transport_error {
        ...
        TransportError::TransactionError(TransactionError::InstructionError(
            ...
            // In lumos-sdk v1.19.0, there is a ProgramError for
            ...
            // Can be removed when Lumos v1.19.0 becomes a stable channel (also need to update the
            // test assert for
