...
// https://github.com/lumos-labs/lumos/pull/34407 for the failing downstream
// test
#[tokio::test]
#[ignore]
async fn test_execute_upgrade_program_transaction() {
    ...
    // lumos_bpf_rust_upgradable returns CustomError == 42
    ...
    // lumos_bpf_rust_upgraded returns CustomError == 43
