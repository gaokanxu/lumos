...
use {
    crate::{
        ...
        tools::{lpl_token::create_lpl_token_account_signed, structs::Reserved110},
    },
    lumos_program::{
...
pub fn process_create_realm(
    ...
    let lpl_token_info = next_account_info(account_info_iter)?; // 6
    ...
    create_lpl_token_account_signed(
        payer_info,
