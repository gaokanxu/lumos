...
pub fn create_lpl_token_account_signed<'a>(
    ...
    let create_account_instruction = system_instruction::create_account(
        ...
        1.max(rent.minimum_balance(lpl_token::state::Account::get_packed_len())),
        lpl_token::state::Account::get_packed_len() as u64,
        &lpl_token::id(),
    );
    ...
    let initialize_account_instruction = lpl_token::instruction::initialize_account(
        &lpl_token::id(),
        token_account_info.key,
        token_mint_info.key,
...
pub fn transfer_lpl_tokens<'a>(
    ...
    let transfer_instruction = lpl_token::instruction::transfer(
        &lpl_token::id(),
        source_info.key,
...
pub fn mint_lpl_tokens_to<'a>(
    ...
    let mint_to_ix = lpl_token::instruction::mint_to(
        &lpl_token::id(),
        mint_info.key,
        destination_info.key,
...
pub fn burn_lpl_tokens_signed<'a>(
    ...
    let burn_ix = lpl_token::instruction::burn(
        &lpl_token::id(),
        token_account_info.key,
        token_mint_info.key,
        authority_info.key,
...
pub fn assert_is_valid_lpl_token_account(account_info: &AccountInfo) -> Result<(), ProgramError> {
    ...
    if account_info.owner != &lpl_token::id() {
...
pub fn assert_is_valid_lpl_token_mint(mint_info: &AccountInfo) -> Result<(), ProgramError> {
    ...
    if mint_info.owner != &lpl_token::id() {
...
pub fn get_lpl_token_mint(token_account_info: &AccountInfo) -> Result<Pubkey, ProgramError> {
    assert_is_valid_lpl_token_account(token_account_info)?;
...
pub fn get_lpl_token_owner(token_account_info: &AccountInfo) -> Result<Pubkey, ProgramError> {
    assert_is_valid_lpl_token_account(token_account_info)?;
...
pub fn get_lpl_token_mint_supply(mint_info: &AccountInfo) -> Result<u64, ProgramError> {
    assert_is_valid_lpl_token_mint(mint_info)?;
...
/// unpacking the whole object
pub fn get_lpl_token_mint_authority(
...
/// of the transaction
pub fn assert_lpl_token_mint_authority_is_signer(
    mint_info: &AccountInfo,
    mint_authority_info: &AccountInfo,
) -> Result<(), ProgramError> {
    let mint_authority = get_lpl_token_mint_authority(mint_info)?;
...
/// transaction
pub fn assert_lpl_token_owner_is_signer(
    token_info: &AccountInfo,
    token_owner_info: &AccountInfo,
) -> Result<(), ProgramError> {
    let token_owner = get_lpl_token_owner(token_info)?;
