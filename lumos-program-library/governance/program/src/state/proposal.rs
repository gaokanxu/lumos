...
use {
    crate::{
        ...
        tools::lpl_token::get_lpl_token_mint_supply,
    ...
    lpl_governance_tools::account::{get_account_data, get_account_type, AccountMaxSize},
...
impl ProposalV2 {
    ...
    pub fn resolve_max_voter_weight(
        ...
        let vote_governing_token_mint_supply =
            get_lpl_token_mint_supply(vote_governing_token_mint_info)?;
