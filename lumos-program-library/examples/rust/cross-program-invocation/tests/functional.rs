...
use {
    ...
    lumos_program_test::*,
    lumos_sdk::{account::Account, signature::Signer, transaction::Transaction},
    lpl_example_cross_program_invocation::processor::{process_instruction, SIZE},
    std::str::FromStr,
};
...
async fn test_cross_program_invocation() {
    ...
    let mut program_test = ProgramTest::new(
        "lpl_example_cross_program_invocation",
        program_id,
