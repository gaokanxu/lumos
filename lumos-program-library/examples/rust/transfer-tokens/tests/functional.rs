use {
    ...
    lumos_sdk::{signature::Signer, signer::keypair::Keypair, transaction::Transaction},
    lpl_example_transfer_tokens::processor::process_instruction,
    lpl_token::state::{Account, Mint},
    std::str::FromStr,
};
...
async fn success() {
    ...
    // Setup the mint, used in `lpl_token::instruction::transfer_checked`
