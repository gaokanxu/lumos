...
#[discriminator_hash_input("lpl_token_group_interface:initialize_token_group")]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("lpl_token_group_interface:update_group_max_size")]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("lpl_token_group_interface:update_authority")]
