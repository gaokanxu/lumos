...
use {
    ...
    lpl_discriminator::SplDiscriminate,
    lpl_pod::{error::PodSliceError, optional_keys::OptionalNonZeroPubkey, primitives::PodU32},
};

/// Data struct for a `TokenGroup`
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("lpl_token_group_interface:group")]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, Default, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("lpl_token_group_interface:member")]
...
mod tests {
    use {
        ...
        crate::NAMESPACE,
        lumos_program::hash,
        lpl_discriminator::ArrayDiscriminator,
        lpl_type_length_value::state::{TlvState, TlvStateBorrowed, TlvStateMut},
        std::mem::size_of,
    };
