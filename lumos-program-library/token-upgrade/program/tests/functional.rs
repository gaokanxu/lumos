...
async fn setup() -> (
    ...
    let mut program_test = ProgramTest::new(
        ...
        processor!(lpl_token_upgrade::processor::process),
    );
    ...
    program_test.add_program(
        "lpl_token",
        lpl_token::id(),
        processor!(lpl_token::processor::Processor::process),
    );
...
#[test_case(lpl_token::id(), lpl_token_2022::id() ; "upgrade to token-2022")]
#[test_case(lpl_token_2022::id(), lpl_token::id() ; "downgrade to token")]
#[test_case(lpl_token::id(), lpl_token::id() ; "token to token")]
#[test_case(lpl_token_2022::id(), lpl_token_2022::id() ; "token-2022 to token-2022")]
#[tokio::test]
...
#[test_case(lpl_token::id(), lpl_token_2022::id() ; "fail upgrade to token-2022")]
#[tokio::test]
