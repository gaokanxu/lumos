...
use {
    helpers::*,
    lumos_program::{instruction::InstructionError, pubkey::Pubkey},
    lumos_program_test::*,
    lumos_sdk::{
...
//#[test_case(lpl_token_2022::id(); "token-2022")] enable once metaplex supports token-2022
#[tokio::test]
...
async fn fail_manager_did_not_sign() {
    let (mut context, stake_pool_accounts) = setup(lpl_token::id()).await;
