...
use {
    ...
    lumos_program::{bpf_loader, entrypoint::ProgramResult, pubkey::Pubkey, system_program},
...
impl NativeTokenSwap {
    pub fn new(
        ...
        let mut swap_account =
            NativeAccountData::new(SwapVersion::LATEST_LEN, lpl_token_swap::id());
        ...
        let mut pool_token_program_account = create_program_account(lpl_token::id());
        let token_a_program_account = create_program_account(lpl_token::id());
        let token_b_program_account = create_program_account(lpl_token::id());
