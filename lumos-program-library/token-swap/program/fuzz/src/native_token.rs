use {
    ...
    lpl_token::state::{Account as TokenAccount, AccountState as TokenAccountState, Mint},
};

pub fn create_mint(owner: &Pubkey) -> NativeAccountData {
    let mut account_data = NativeAccountData::new(Mint::LEN, lpl_token::id());
    let mint = Mint {
        is_initialized: true,
...
pub fn create_token_account(
    ...
    let mut account_data = NativeAccountData::new(TokenAccount::LEN, lpl_token::id());
