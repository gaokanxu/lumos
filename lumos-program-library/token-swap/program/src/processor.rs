...
use {
    ...
    lpl_token_2022::{
        check_lpl_token_program_account,
        error::TokenError,
        extension::{
...
impl Processor {
    /// Unpacks a lpl_token `Account`.
    pub fn unpack_token_account(
        account_info: &AccountInfo,
        token_program_id: &Pubkey,
    ) -> Result<Account, SwapError> {
        if account_info.owner != token_program_id
            && check_lpl_token_program_account(account_info.owner).is_err()
        {
    ...
    /// Unpacks a lpl_token `Mint` with extension data
    pub fn unpack_mint_with_extensions<'a>(
        account_data: &'a [u8],
        owner: &Pubkey,
        token_program_id: &Pubkey,
    ) -> Result<StateWithExtensions<'a, Mint>, SwapError> {
        if owner != token_program_id && check_lpl_token_program_account(owner).is_err() {
            Err(SwapError::IncorrectTokenProgramId)
        } else {
    ...
    /// Issue a lpl_token `Burn` instruction.
    pub fn token_burn<'a>(
        swap: &Pubkey,
        ...
        let ix = lpl_token_2022::instruction::burn(
            token_program.key,
            burn_account.key,
            mint.key,
            authority.key,
    ...
    /// Issue a lpl_token `MintTo` instruction.
    pub fn token_mint_to<'a>(
        ...
        let authority_signature_seeds = [&swap_bytes[..32], &[bump_seed]];
        let signers = &[&authority_signature_seeds[..]];
        let ix = lpl_token_2022::instruction::mint_to(
            token_program.key,
            mint.key,
            destination.key,
            authority.key,
    ...
    /// Issue a lpl_token `Transfer` instruction.
    ...
    pub fn token_transfer<'a>(
        ...
        let authority_signature_seeds = [&swap_bytes[..32], &[bump_seed]];
        let signers = &[&authority_signature_seeds[..]];
        let ix = lpl_token_2022::instruction::transfer_checked(
            token_program.key,
            source.key,
            mint.key,
            destination.key,
...
mod tests {
    use {
        ...
        lumos_sdk::account::{
            create_account_for_test, create_is_signer_account_infos, Account as LumosAccount,
        },
        lpl_token_2022::{
            error::TokenError,
            extension::{
    ...
    impl program_stubs::SyscallStubs for TestSyscallStubs {
        fn sol_invoke_signed(
            ...
            if !account_infos
                .iter()
                .any(|x| *x.key == lpl_token::id() || *x.key == lpl_token_2022::id())
            {
            ...
            if instruction.program_id == lpl_token::id() {
                lpl_token::processor::Processor::process(
                    &instruction.program_id,
                    &new_account_infos,
                    &instruction.data,
                )
            } else if instruction.program_id == lpl_token_2022::id() {
                lpl_token_2022::processor::Processor::process(
                    &instruction.program_id,
                    &new_account_infos,
                    &instruction.data,
                )
    ...
    struct SwapAccountInfo {
        ...
        swap_curve: SwapCurve,
        swap_key: Pubkey,
        swap_account: LumosAccount,
        pool_mint_key: Pubkey,
        pool_mint_account: LumosAccount,
        pool_fee_key: Pubkey,
        pool_fee_account: LumosAccount,
        pool_token_key: Pubkey,
        pool_token_account: LumosAccount,
        token_a_key: Pubkey,
        token_a_account: LumosAccount,
        token_a_mint_key: Pubkey,
        token_a_mint_account: LumosAccount,
        token_b_key: Pubkey,
        token_b_account: LumosAccount,
        token_b_mint_key: Pubkey,
        token_b_mint_account: LumosAccount,
    ...
    impl SwapAccountInfo {
        ...
        pub fn new(
            ...
            let swap_account = LumosAccount::new(0, SwapVersion::LATEST_LEN, &SWAP_PROGRAM_ID);
        ...
        fn get_token_mint(&self, account_key: &Pubkey) -> (Pubkey, LumosAccount) {
            if *account_key == self.token_a_key {
        ...
        fn get_token_account(&self, account_key: &Pubkey) -> &LumosAccount {
            if *account_key == self.token_a_key {
        ...
        fn set_token_account(&mut self, account_key: &Pubkey, account: LumosAccount) {
            if *account_key == self.token_a_key {
        ...
        pub fn swap(
            ...
            user_source_account: &mut LumosAccount,
            swap_source_key: &Pubkey,
            swap_destination_key: &Pubkey,
            user_destination_key: &Pubkey,
            user_destination_account: &mut LumosAccount,
            amount_in: u64,
            minimum_amount_out: u64,
        ) -> ProgramResult {
        ...
        pub fn deposit_all_token_types(
            ...
            depositor_token_a_account: &mut LumosAccount,
            depositor_token_b_key: &Pubkey,
            depositor_token_b_account: &mut LumosAccount,
            depositor_pool_key: &Pubkey,
            depositor_pool_account: &mut LumosAccount,
            pool_token_amount: u64,
            maximum_token_a_amount: u64,
            maximum_token_b_amount: u64,
        ) -> ProgramResult {
        ...
        pub fn withdraw_all_token_types(
            ...
            user_key: &Pubkey,
            pool_key: &Pubkey,
            pool_account: &mut LumosAccount,
            token_a_key: &Pubkey,
            token_a_account: &mut LumosAccount,
            token_b_key: &Pubkey,
            token_b_account: &mut LumosAccount,
            pool_token_amount: u64,
            minimum_token_a_amount: u64,
            minimum_token_b_amount: u64,
        ) -> ProgramResult {
        ...
        pub fn deposit_single_token_type_exact_amount_in(
            ...
            deposit_token_account: &mut LumosAccount,
            deposit_pool_key: &Pubkey,
            deposit_pool_account: &mut LumosAccount,
            source_token_amount: u64,
            minimum_pool_token_amount: u64,
        ) -> ProgramResult {
            let user_transfer_authority_key = Pubkey::new_unique();
        ...
        pub fn withdraw_single_token_type_exact_amount_out(
            ...
            destination_account: &mut LumosAccount,
            destination_token_amount: u64,
            maximum_pool_token_amount: u64,
        ) -> ProgramResult {
            let user_transfer_authority_key = Pubkey::new_unique();
    ...
    fn mint_minimum_balance() -> u64 {
        Rent::default().minimum_balance(lpl_token::state::Mint::get_packed_len())
    }

    fn account_minimum_balance() -> u64 {
        Rent::default().minimum_balance(lpl_token::state::Account::get_packed_len())
    }

    fn do_process_instruction_with_fee_constraints(
        instruction: Instruction,
        accounts: Vec<&mut LumosAccount>,
        swap_constraints: &Option<SwapConstraints>,
    ) -> ProgramResult {
        test_syscall_stubs();
        ...
        } else if instruction.program_id == lpl_token::id() {
            lpl_token::processor::Processor::process(
                &instruction.program_id,
                &account_infos,
                &instruction.data,
    ...
    fn mint_token(
        program_id: &Pubkey,
        mint_key: &Pubkey,
        mint_account: &mut LumosAccount,
        mint_authority_key: &Pubkey,
        account_owner_key: &Pubkey,
        amount: u64,
    ) -> (Pubkey, LumosAccount) {
        let account_key = Pubkey::new_unique();
        let space = if *program_id == lpl_token_2022::id() {
        ...
        let mut account_account = LumosAccount::new(minimum_balance, space, program_id);
        let mut mint_authority_account = LumosAccount::default();
    ...
    fn create_mint(
        ...
        let minimum_balance = Rent::default().minimum_balance(space);
        let mut mint_account = LumosAccount::new(minimum_balance, space, program_id);
        let mut rent_sysvar_account = create_account_for_test(&Rent::free());

        if *program_id == lpl_token_2022::id() {
            if close_authority.is_some() {
                do_process_instruction(
    ...
    #[test_case(lpl_token::id(); "token")]
    #[test_case(lpl_token_2022::id(); "token-2022")]
    fn test_token_program_id_error(token_program_id: Pubkey) {
        test_syscall_stubs();
        let swap_key = Pubkey::new_unique();
        let mut mint = (Pubkey::new_unique(), LumosAccount::default());
        let mut destination = (Pubkey::new_unique(), LumosAccount::default());
        let token_program = (token_program_id, LumosAccount::default());
        let (authority_key, bump_seed) =
            Pubkey::find_program_address(&[&swap_key.to_bytes()[..]], &SWAP_PROGRAM_ID);
        let mut authority = (authority_key, LumosAccount::default());
    ...
    fn test_token_error(token_program_id: Pubkey) {
        ...
        let mut mint = (
            ...
            LumosAccount::new(
                ...
                lpl_token::state::Mint::get_packed_len(),
                &token_program_id,
            ),
        );
        let mut destination = (
            ...
            LumosAccount::new(
                ...
                lpl_token::state::Account::get_packed_len(),
                &token_program_id,
            ),
        );
        let mut token_program = (token_program_id, LumosAccount::default());
        let (authority_key, bump_seed) =
            Pubkey::find_program_address(&[&swap_key.to_bytes()[..]], &SWAP_PROGRAM_ID);
        let mut authority = (authority_key, LumosAccount::default());
        let swap_bytes = swap_key.to_bytes();
    ...
    #[test_case(lpl_token::id(), lpl_token::id(), lpl_token::id(); "all-token")]
    #[test_case(lpl_token_2022::id(), lpl_token_2022::id(), lpl_token_2022::id(); "all-token-2022")]
    #[test_case(lpl_token::id(), lpl_token_2022::id(), lpl_token_2022::id(); "mixed-pool-token")]
    #[test_case(lpl_token_2022::id(), lpl_token_2022::id(), lpl_token::id(); "mixed-pool-token-2022")]
    fn test_initialize(
        pool_token_program_id: Pubkey,
        token_a_program_id: Pubkey,
        token_b_program_id: Pubkey,
        ...
        // uninitialized token a account
        {
            ...
            accounts.token_a_account = LumosAccount::new(0, 0, &token_a_program_id);
            assert_eq!(
        ...
        // uninitialized token b account
        {
            ...
            accounts.token_b_account = LumosAccount::new(0, 0, &token_b_program_id);
            assert_eq!(
                Err(SwapError::ExpectedAccount.into()),
                accounts.initialize_swap()
            );
        ...
        // uninitialized pool mint
        {
            ...
            accounts.pool_mint_account = LumosAccount::new(0, 0, &pool_token_program_id);
            assert_eq!(
        ...
        if pool_token_program_id == lpl_token_2022::id() {
            let (_pool_mint_key, pool_mint_account) = create_mint(
                &pool_token_program_id,
                &accounts.authority_key,
                None,
        ...
        // token A account is delegated
        {
            ...
            do_process_instruction(
                ...
                .unwrap(),
                vec![&mut accounts.token_a_account, &mut LumosAccount::default()],
            )
            .unwrap();
        }
        ...
        // token B account is delegated
        {
            ...
            do_process_instruction(
                ...
                .unwrap(),
                vec![&mut accounts.token_b_account, &mut LumosAccount::default()],
            )
            .unwrap();
        }
    ...
    fn test_withdraw_with_invalid_fee_account(
        ...
        let mut destination = LumosAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &withdrawer_key,
        );
