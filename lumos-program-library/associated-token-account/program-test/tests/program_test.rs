use {
    ...
    lpl_associated_token_account::{id, processor::process_instruction},
};

#[allow(dead_code)]
pub fn program_test(token_mint_address: Pubkey, use_latest_lpl_token: bool) -> ProgramTest {
    ...
    //      $ lumos account EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v \
...
pub fn program_test_2022(
    ...
    use_latest_lpl_token_2022: bool,
) -> ProgramTest {
    let mut pc = ProgramTest::new(
        "lpl_associated_token_account",
        id(),
