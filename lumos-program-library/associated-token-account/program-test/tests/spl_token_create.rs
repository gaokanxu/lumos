...
#[allow(deprecated)]
use lpl_associated_token_account::create_associated_token_account as deprecated_create_associated_token_account;
use {
    program_test::program_test,
    lumos_program::pubkey::Pubkey,
    lumos_program_test::*,
    lumos_sdk::{program_pack::Pack, signature::Signer, transaction::Transaction},
...
async fn success_create() {
    ...
    assert_eq!(associated_account.owner, lpl_token::id());
