...
use {
    ...
    lumos_program::{instruction::*, pubkey::Pubkey, system_instruction, sysvar},
    lumos_program_test::*,
    lumos_sdk::{
        signature::Signer,
    ...
    lpl_token_2022::{extension::ExtensionType, state::Account},
};
...
async fn test_associated_token_address() {
    ...
    assert_eq!(associated_account.owner, lpl_token_2022::id());
