use {
    ...
    lumos_cli_config::CONFIG_FILE,
    lumos_remote_wallet::remote_wallet::maybe_wallet_manager,
    lumos_sdk::native_token::sol_to_lamports,
    ...
    App::new(crate_name!())
            ...
            SubCommand::with_name("distribute-tokens")
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in LUM"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_lum")
                        .default_value("1.0")
                        .long("unlocked-sol")
                        .takes_value(true)
                        .value_name("LUM_AMOUNT")
                        .help("Amount of LUM to put in system account to pay for fees"),
                )
                .arg(
...
fn parse_create_stake_args(
    ...
    let stake_args = StakeArgs {
        unlocked_lum: sol_to_lamports(value_t_or_exit!(matches, "unlocked_lum", f64)),
        lockup_authority,
