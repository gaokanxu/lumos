...
use {
    ...
    lumos_zk_token_sdk::encryption::{auth_encryption::AeKey, elgamal::ElGamalKeypair},
    std::{
        cell::RefCell,
        error,
...
impl DefaultSigner {
    ...
    /// use lumos_clap_v3_utils::keypair::DefaultSigner;
    /// use lumos_clap_v3_utils::offline::OfflineArgs;
    ///
    ...
    /// ```no_run
    /// use clap::{Arg, Command};
    /// use lumos_clap_v3_utils::keypair::{DefaultSigner, signer_from_path};
    /// use lumos_clap_v3_utils::offline::OfflineArgs;
    ...
    /// ```no_run
    /// use clap::{Arg, Command};
    /// use lumos_clap_v3_utils::keypair::{SignerFromPathConfig, DefaultSigner};
    /// use lumos_clap_v3_utils::offline::OfflineArgs;
    ///
    /// let clap_app = Command::new("my-program")
    ///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{Arg, Command};
/// use lumos_clap_v3_utils::keypair::signer_from_path;
/// use lumos_clap_v3_utils::offline::OfflineArgs;
///
/// let clap_app = Command::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{Arg, Command};
/// use lumos_clap_v3_utils::keypair::{signer_from_path_with_config, SignerFromPathConfig};
/// use lumos_clap_v3_utils::offline::OfflineArgs;
///
/// let clap_app = Command::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{Arg, Command};
/// use lumos_clap_v3_utils::keypair::pubkey_from_path;
///
/// let clap_app = Command::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::new("keypair")
...
/// ```no_run
/// use clap::{Arg, Command};
/// use lumos_clap_v3_utils::keypair::keypair_from_path;
///
/// let clap_app = Command::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::new("keypair")
...
/// ```no_run`
/// use clap::{Arg, Command};
/// use lumos_clap_v3_utils::keypair::elgamal_keypair_from_path;
///
/// let clap_app = Command::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run`
/// use clap::{Arg, Command};
/// use lumos_clap_v3_utils::keypair::ae_key_from_path;
///
/// let clap_app = Command::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::new("ae-key")
...
mod tests {
    use {
        ...
        clap::{Arg, Command},
        lumos_remote_wallet::remote_wallet::initialize_wallet_manager,
