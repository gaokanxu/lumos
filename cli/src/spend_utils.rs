use {
    ...
    clap::ArgMatches,
    lumos_clap_utils::{input_parsers::lamports_of_lum, offline::SIGN_ONLY_ARG},
    lumos_rpc_client::rpc_client::RpcClient,
    lumos_sdk::{
        commitment_config::CommitmentConfig, hash::Hash, message::Message,
        native_token::lamports_to_lum, pubkey::Pubkey,
    },
};
...
impl SpendAmount {
    ...
    pub fn new_from_matches(matches: &ArgMatches<'_>, name: &str) -> Self {
        let amount = lamports_of_lum(matches, name);
