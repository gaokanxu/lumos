use {
    ...
    lumos_vote::vote_transaction::{VoteTransaction, VoteTransaction::VoteStateUpdate},
    std::{
...
mod tests {
    use {
        ...
        lumos_sdk::slot_hashes::MAX_ENTRIES,
        lumos_vote_program::vote_state::{Lockout, Vote, VoteStateUpdate},
    ...
    fn test_verified_vote_packets_receive_and_process_vote_packets() {
        let (s, r) = unbounded();
        let vote_account_key = lumos_sdk::pubkey::new_rand();
