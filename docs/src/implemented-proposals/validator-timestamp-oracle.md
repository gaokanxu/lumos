...
Third-party users of Lumos sometimes need to know the real-world time a block
...
would allow a Lumos cluster to satisfy this need.
...
As of https://github.com/lumos-labs/lumos/pull/10630, validators submit a
