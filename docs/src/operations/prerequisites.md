---
title: Lumos Validator Prerequisites
sidebar_position: 2
sidebar_label: Prerequisites
pagination_label: Prerequisites to run a Validator
---

Operating a Lumos validator is an interesting and rewarding task. Generally speaking, it requires someone with a technical background but also involves community engagement and marketing.
...
- Performant computer hardware and a fast internet connection
  ...
  - Lumos helps facilitate data-center server rentals through the [Lumos server program](https://lumos.foundation/server-program)
