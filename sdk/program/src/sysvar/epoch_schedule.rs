...
//!
//! See also the Lumos [documentation on the epoch schedule sysvar][sdoc].
//!
//! [sdoc]: https://docs.lumoslabs.com/runtime/sysvars#epochschedule
//!
//! # Examples
//!
...
//! # use lumos_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #
