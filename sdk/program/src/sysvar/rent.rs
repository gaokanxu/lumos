...
//!
//! [rent]: https://docs.lumoslabs.com/implemented-proposals/rent
//!
...
//!
//! See also the Lumos [documentation on the rent sysvar][sdoc].
//!
//! [sdoc]: https://docs.lumoslabs.com/runtime/sysvars#rent
//!
//! # Examples
//!
...
//! # use lumos_sdk::sysvar::rent::{self, Rent};
//! # use anyhow::Result;
//! #
