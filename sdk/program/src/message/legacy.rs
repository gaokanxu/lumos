//! The original and current Lumos message format.
//!
...
/// A Lumos transaction message (legacy).
///
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`lumos_sdk`], [`lumos_rpc_client`] and [`anyhow`] crates.
    ///
    ...
    ///
    /// [nonced transaction]: https://docs.lumoslabs.com/implemented-proposals/durable-tx-nonces
    ///
    ...
    ///
    /// [`lumos_sdk`]: https://docs.rs/lumos-sdk
    /// [`lumos_rpc_client`]: https://docs.rs/lumos-client
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use lumos_program::example_mocks::lumos_sdk;
...
mod tests {
    ...
    fn test_message_hash() {
        ...
        // in this case, the domain prefix `lumos-tx-message-v1` should be updated.
