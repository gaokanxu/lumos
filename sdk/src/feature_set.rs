...
//! the process of getting a feature into the core Lumos code.
...
//!   <https://spl.lumos.com/feature-proposal#feature-proposal-life-cycle>
//!
//! 1. Generate a new keypair with `lumos-keygen new --outfile feature.json --no-passphrase`
...
//!    `lumos_sdk::declare_id!()` within the module.
...
use {
    ...
    lumos_program::{epoch_schedule::EpochSchedule, stake_history::Epoch},
    lumos_sdk::{
        clock::Slot,
        hash::{Hash, Hasher},
        pubkey::Pubkey,
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (stake_raise_minimum_delegation_to_1_lum::id(), "Raise minimum stake delegation to 1.0 LUM #24357"),
