...
```bash
$ git clone https://github.com/gaokanxu/lumos.git
$ cd lumos
```
...
devnet.lumos.uuhb.com. Runs 24/7. Learn more about the [public clusters]
...
are done with the Lumos Labs, Inc. (“LL”) good faith efforts. It is up to
