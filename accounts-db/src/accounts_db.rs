...
pub mod tests {
    ...
    fn test_clean_old_with_both_normal_and_zero_lamport_accounts() {
        ...
        let mut accounts = AccountsDb {
            account_indexes: lpl_token_mint_index_enabled(),
        ...
        let mut account_data_with_mint = vec![0; inline_lpl_token::Account::get_packed_len()];
        ...
        normal_account.set_owner(inline_lpl_token::id());
        ...
        zero_account.set_owner(inline_lpl_token::id());
